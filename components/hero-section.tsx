    ...
    <section className={`container mx-auto px-4 py-16 md:py-24 ${className}`}>
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center">
        <div className="space-y-4 lg:space-y-6 text-center lg:text-left">
          <h1 className="text-[32px] leading-[40px] sm:text-[42px] sm:leading-[50px] lg:text-[72px] font-bold lg:leading-[85px]">
            <span className="whitespace-nowrap">This is <span className="bg-[#FF6B7A] text-white px-2 py-1 inline-block">MaqAura</span>,</span>
            <br />
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="relative w-full max-w-sm sm:max-w-md aspect-square bg-[#FDB927] border-4 border-black overflow-hidden shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-none">
            <img
              src="/hero-image.png"
