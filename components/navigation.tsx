...
export function Navigation({ className }: NavigationProps) {
  return (
    <div className={`container mx-auto px-4 pt-8 pb-4 ${className}`}>
      <nav className="flex items-center justify-between bg-white border-4 border-black max-w-2xl mx-auto shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] px-3 sm:px-6 py-4 sm:py-7 rounded-none gap-2 sm:gap-4">
